...
function FormTema() {
      ...
      if(id !== undefined){
        try{
          ...
          if(error.toString().includes('401')){
            ...
            ToastAlerta('Error ao atualizar o tema.', 'erro')
          }
        }
      }else{
        try{
  ...
  return (
    <div className='container flex flex-col items-center justify-center mx-auto'>
      <h1 className='text-4xl text-center my-8'>{id === undefined ? 'Cadastrar' : 'Atualizar'}
      Tema
      </h1>
      ...
      <form className="w-1/2 flex flex-col gap-4"
        ...
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            name="descricao"
            className="border-2 border-pink-900 rounded p-2"
            value={tema.descricao}
            onChange={(e: ChangeEvent<HTMLInputElement>) => atualizarEstado(e)}
          />
        </div>
        <button className="rounded text-pink-100 bg-pink-400
